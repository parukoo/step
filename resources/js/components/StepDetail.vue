...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      normalShare(kostep){
        //シェアする画面を設定
        var shareURL = 'https://twitter.com/intent/tweet?text=' + "STEP「" + this.title + "」：FLOW-1" + kostep.title + "%20%23STEPで学び方を共有しよう" + '&url=' + "https://step.chew.jp/" + this.stepid;  
        //シェア用の画面へ移行
      ...
      twitterShare(){
        //シェアする画面を設定
        var shareURL = 'https://twitter.com/intent/tweet?text=' + this.title + "を完了しました！" + "%20%23STEPで学び方を共有しよう" + '&url=' + "https://step.chew.jp/" + this.stepid;  
        //シェア用の画面へ移行
        location.href = shareURL
      }
    },
